...
def test_backup_publishes_verified_relocatable_artifacts():
    with tempfile.TemporaryDirectory() as directory:
        ...
        result = subprocess.run(
            ...
            env={**os.environ, "PATH": f"{tools}:{os.environ['PATH']}", "PGHOST": "synthetic.invalid", "PGPORT": "5432", "PGDATABASE": "codestra_social", "PGUSER": "synthetic", "PGPASSFILE": str(passfile), "CODESTRA_SOCIAL_BACKUP_ROOT": str(backup_root), "CODESTRA_RELEASE_SHA": "1" * 40, "CODESTRA_IMAGE_DIGEST": "sha256:" + "2" * 64, "CODESTRA_BACKUP_GPG_RECIPIENT": "synthetic-test-recipient"},
